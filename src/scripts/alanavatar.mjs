...
badge.to(".badge, .badge-shadow", 10, {
    rotation: "360",
...
const alanavatar = document.querySelectorAll("#alanavatar");
alanavatar.forEach(function (el) {
...
const dom = {
    ...
    hairFringe: document.querySelector(".hair"),
